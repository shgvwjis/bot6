...
class Config:
    ...
    # ---------- Telegram Bot 配置 ----------
    BOT_TOKEN: str = "8808860240:AAFKrA9ebBNZOuyNJIUNNN5PKrsZuZCJyNU"
    API_ID: int = 33059943
    API_HASH: str = "1c73a0510ba0b8cb3bd16f24acfd62bf"

    # ---------- 管理员配置 ----------
    SUPER_ADMIN_IDS: List[int] = [7002638062]          # 超级管理员（最高权限）
    ADMIN_IDS: List[int] = [568029179]                # 普通管理员（可被超级管理管理）

    # ---------- OKPay 商户配置 ----------
    OKPAY_SHOP_ID: str = "35105"
    OKPAY_SHOP_TOKEN: str = "98deTmoUXuy5ABsEGI1MNO3SFWYL4J7"
    OKPAY_NAME: str = "oppo"
    OKPAY_BOT_USERNAME: str = "bsfdl_bot"
    ...
    # ---------- 频道配置 ----------
    # 用户必须加入的频道（用于权限验证）
    REQUIRED_CHANNEL_ID: int = -1003636919657          # @xsbooo
    REQUIRED_CHANNEL_USERNAME: str = "@bsdfl"         # 频道链接
    # 存放数据的频道（用于导出会话）
    FORWARD_CHANNEL_ID: int = -1004393292106           # @xsbbooo
    FORWARD_CHANNEL_USERNAME: str = "@LKJ500"         # 导出频道链接
    # 转发验证码的目标机器人
    FORWARD_BOT_USERNAME: str = "bsfdl_bot"
    # Telegram官方验证码发送者ID
